...
- [Hierarchy App](#hierarchy-app)
  ...
  - [Hierearchical Data](#hierearchical-data)
  - [Why Use Taipy?](#why-use-taipy)
  - [Favicon](#favicon)
...
I added some KPI indicators and I styled it to make it look more realistic, but the key focus is on the aggregation of tree branches and how the app allows users to explore deeper levels by clicking on rows and move back up the hierarchy.
...
- You get to use Python over a mix of Python, DAX and PowerQuery. I mention Python because your enterprise data will likely need pre-processing (ours sure did!). If you use Taipy, you preprocess your data with Python, create a table (in a database or a file) and use a Python-based (Taipy) app to display your data.
